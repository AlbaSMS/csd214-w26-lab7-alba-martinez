...
public class Lecture9StarterAlbaMartinezApplication implements CommandLineRunner {
    // 1. Declare our dependency
    private final ProductRepository productRepository;

    // 2. Constructor Injection
    // Spring automatically provides the repository when starting the app
    public Lecture9StarterAlbaMartinezApplication(ProductRepository productRepository) {
        this.productRepository = productRepository;
    }

    // Standard Java entry point
	public static void main(String[] args) {
		SpringApplication.run(Lecture9StarterAlbaMartinezApplication.class, args);
	}
